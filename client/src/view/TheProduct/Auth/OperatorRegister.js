...
import { registerOperatorAction } from '../../../reducer/requestEndpoints';
...
const OperatorRegister = () => {
	...
	useEffect(() => {
		console.log(theme);
		if (theme) {
			setBrand({ ...brand, brandname: theme });
		}
	}, [theme]);
		...
		<div className='register-pg-container'>
			...
			<div className='content-contain register'>
				<div className='card register-form'>
					...
					<Form name='normal_login' onFinish={onFinish} form={form} layout='vertical' initialValues={brand.brandname}>
						<Form.Item
							name='username'
							label='Username'
							rules={[
					...
					<span style={{ color: 'grey' }}>Already have an account?</span> <a href='/operator_login'>Sign in</a>
					<br />
					<div>
